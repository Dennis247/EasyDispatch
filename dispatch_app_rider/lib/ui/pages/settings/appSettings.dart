...
class _AppSettingsState extends State<AppSettings> {
  ...
  bool _stopLocationService = false;
  ...
  void initState() {
    ...
    _stopLocationService =
        locator<SettingsServices>().appSettings.stopLocationService;
  ...
  void _saveSettings() async {
    ...
    try {
      Settings settings = new Settings(
          ...
          stopLocationService: _stopLocationService);
      final response =
          await locator<SettingsServices>().saveAppSettings(settings);
      //update location service
      Provider.of<LocationProvider>(context, listen: false)
          .startLocationService(start: !_stopLocationService);
      //
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              Expanded(
                                child: Text(
                                  "Stop Locaion Service",
                                  style: AppTextStyles.appTextStyle,
                                ),
                              ),
                              Switch(
                                  value: _stopLocationService,
                                  onChanged: (bool value) {
                                    setState(() {
                                      _stopLocationService = value;
                                    });
                                  })
                            ],
                          ),
